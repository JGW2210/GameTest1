...
export const PROFILES = {
  ...
  'Enterococcus faecalis': {
    gram: P, shape: ['Cocci', 'Chains'], motility: 'Non-motile', spores: N,
    oxidase: N, catalase: N, aesculin: P, pyr: P,
    fermentation: ['Glucose'], of: 'Fermentative', haemolysis: 'Gamma', atmosphere: 'Facultative',
  },
  ...
  'Clostridium tetani': {
    ...
    oxidase: N, catalase: N, of: 'Non-reactive', haemolysis: 'Beta', atmosphere: 'Anaerobe',
  },
  'Clostridium botulinum': {
    gram: P, shape: ['Bacilli'], motility: 'Motile', spores: P,
    oxidase: N, catalase: N, fermentation: ['Glucose'], atmosphere: 'Anaerobe',
  },
  ...
  'Cutibacterium acnes': {
    gram: P, shape: ['Bacilli'], motility: 'Non-motile', spores: N,
    catalase: P, indole: P, atmosphere: 'Anaerobe',
  },
  'Actinomyces israelii': {
    gram: P, shape: ['Bacilli'], motility: 'Non-motile', spores: N,
    catalase: N, atmosphere: 'Anaerobe',
  },

  // ── Acid-fast ────────────────────────────────────────────────────────────
  'Mycobacterium tuberculosis': {
    gram: 'Acid-fast', shape: ['Bacilli'], motility: 'Non-motile', spores: N,
    catalase: V, atmosphere: 'Aerobe',
  },
  ...
  'Nocardia asteroides': {
    gram: P, shape: ['Bacilli'], motility: 'Non-motile', spores: N,
    catalase: P, atmosphere: 'Aerobe',
  },

  // ── Enterobacterales ─────────────────────────────────────────────────────
  'Escherichia coli': {
    gram: N, shape: ['Bacilli'], motility: 'Motile', spores: N,
    oxidase: N, catalase: P, indole: P, methylRed: P, vp: N, citrate: N,
  ...
  'Klebsiella pneumoniae': {
    ...
    oxidase: N, catalase: P, indole: N, methylRed: N, vp: P, citrate: P,
    fermentation: ['Glucose', 'Lactose', 'Sucrose', 'Maltose'], of: 'Fermentative',
    haemolysis: 'Gamma', atmosphere: 'Facultative',
  },
  ...
  'Salmonella enterica': {
    gram: N, shape: ['Bacilli'], motility: 'Motile', spores: N,
    oxidase: N, catalase: P, indole: N, methylRed: P, vp: N, citrate: V,
    fermentation: ['Glucose', 'Maltose', 'Mannitol'], of: 'Fermentative', atmosphere: 'Facultative',
  },
  'Shigella flexneri': {
    gram: N, shape: ['Bacilli'], motility: 'Non-motile', spores: N,
    oxidase: N, catalase: P, indole: V, methylRed: P, vp: N, citrate: N,
    fermentation: ['Glucose', 'Maltose'], of: 'Fermentative', atmosphere: 'Facultative',
  },
  'Shigella dysenteriae': {
    gram: N, shape: ['Bacilli'], motility: 'Non-motile', spores: N,
    oxidase: N, catalase: N, indole: V, methylRed: P, vp: N, citrate: N,
  ...
  'Proteus vulgaris': {
    gram: N, shape: ['Bacilli'], motility: 'Motile', spores: N,
    oxidase: N, catalase: P, indole: P, methylRed: P, vp: N,
    fermentation: ['Glucose', 'Sucrose'], of: 'Fermentative', atmosphere: 'Facultative',
  },
  'Yersinia pestis': {
    gram: N, shape: ['Bacilli'], motility: 'Non-motile', spores: N,
    oxidase: N, catalase: P, indole: N, of: 'Fermentative', atmosphere: 'Facultative',
  },
  'Yersinia enterocolitica': {
    gram: N, shape: ['Bacilli'], motility: 'Temp-variable', spores: N,
    oxidase: N, catalase: P, indole: V, of: 'Fermentative', atmosphere: 'Facultative',
  },
  'Serratia marcescens': {
    gram: N, shape: ['Bacilli'], motility: 'Motile', spores: N,
    oxidase: N, catalase: P, dnase: P, indole: N, vp: P, citrate: P,
    fermentation: ['Glucose'], of: 'Fermentative', atmosphere: 'Facultative',
  },
  ...
  'Pseudomonas aeruginosa': {
    gram: N, shape: ['Bacilli'], motility: 'Motile', spores: N,
    oxidase: P, catalase: P, citrate: P,
    fermentation: [], of: 'Oxidative', haemolysis: 'Beta', atmosphere: 'Aerobe',
  },
  'Stenotrophomonas maltophilia': {
    gram: N, shape: ['Bacilli'], motility: 'Motile', spores: N,
    oxidase: N, catalase: P, dnase: P, of: 'Oxidative', atmosphere: 'Aerobe',
  },
  'Acinetobacter baumannii': {
    gram: N, shape: ['Cocci', 'Bacilli'], motility: 'Non-motile', spores: N,
    oxidase: N, catalase: P, of: 'Oxidative', atmosphere: 'Aerobe',
  },
  'Moraxella catarrhalis': {
    gram: N, shape: ['Diplococci'], motility: 'Non-motile', spores: N,
    oxidase: P, catalase: P, dnase: P, of: 'Non-reactive', atmosphere: 'Aerobe',
  },

  // ── Fastidious Gram-negatives ────────────────────────────────────────────
  'Neisseria meningitidis': {
    gram: N, shape: ['Diplococci'], motility: 'Non-motile', spores: N,
    oxidase: P, catalase: P,
  ...
  'Bordetella pertussis': {
    gram: N, shape: ['Cocci', 'Bacilli'], motility: 'Non-motile', spores: N,
    oxidase: P, catalase: P, of: 'Non-reactive', atmosphere: 'Aerobe',
  },
  'Brucella melitensis': {
    gram: N, shape: ['Cocci', 'Bacilli'], motility: 'Non-motile', spores: N,
    oxidase: P, catalase: P, of: 'Non-reactive', atmosphere: 'Capnophilic',
  },
  'Francisella tularensis': {
    gram: N, shape: ['Cocci', 'Bacilli'], motility: 'Non-motile', spores: N,
    oxidase: N, catalase: V, atmosphere: 'Aerobe',
  },
  'Legionella pneumophila': {
    gram: N, shape: ['Bacilli'], motility: 'Motile', spores: N,
    oxidase: V, catalase: P, of: 'Non-reactive', atmosphere: 'Aerobe',
  },

  // ── Curved / spiral ──────────────────────────────────────────────────────
  'Campylobacter jejuni': {
    gram: N, shape: ['Spiral'], motility: 'Motile', spores: N,
    oxidase: P, catalase: P, of: 'Non-reactive', atmosphere: 'Microaerophilic',
  },
  'Helicobacter pylori': {
    gram: N, shape: ['Spiral'], motility: 'Motile', spores: N,
    oxidase: P, catalase: P, of: 'Non-reactive', atmosphere: 'Microaerophilic',
  ...
  'Bacteroides fragilis': {
    gram: N, shape: ['Bacilli'], motility: 'Non-motile', spores: N,
    catalase: V, aesculin: P, of: 'Fermentative', atmosphere: 'Anaerobe',
  },
  'Fusobacterium nucleatum': {
    gram: N, shape: ['Bacilli'], motility: 'Non-motile', spores: N,
    catalase: N, indole: P, atmosphere: 'Anaerobe',
  },
  'Prevotella melaninogenica': {
    gram: N, shape: ['Bacilli'], motility: 'Non-motile', spores: N,
    catalase: N, indole: N, atmosphere: 'Anaerobe',
  },
  ...
  'Mycoplasma pneumoniae': {
    ...
    catalase: N, fermentation: ['Glucose'], atmosphere: 'Facultative',
  },
};
